...
class UrlCompareForm extends React.Component<FormData, Nothing> {
            ...
            <form className="home-form" onSubmit={handleSubmit}>
                <div className="form-row justify-content-center">
                    <div className="form-group col-md-4">
                        <label className="label">First Url</label>
                        <input type="text" className="form-control" placeholder="Enter URL" />
                    </div>
                    <div className="form-group col-md-4">
                        <label className="label">Second Url</label>
                        <input type="text" className="form-control" placeholder="Enter URL"  />
                    </div>
                </div>
...
>>>>>>> 99f2fc4... little refactoring in user-page
export default UrlCompareForm;